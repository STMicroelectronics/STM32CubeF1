...
![tag](https://img.shields.io/badge/tag-v1.8.7-brightgreen.svg)
...
> 
> If needed, they can be found inside the full firmware package available on our website `st.com` and downloadable from [here](https://www.st.com/en/embedded-software/stm32cubef1.html#get-software). You will be prompted to login, or to register in case you have no account.
...
```bash
git clone --recursive  --depth 1 --branch vX.Y.Z https://github.com/STMicroelectronics/STM32CubeF1.git
```
